...
#### 선택이 어려운 사람
    선택이 어려운 사람을 위한 랜덤 소스통 - 선택이 어려운 사람을 위한 무언가 소스를 만들어 준다 `1`
...
#### 고연령자들도 편리한 도구를 쉽게 이용할 수 있게 도와주는 보조도구
    (키오스크, 배달 앱, 텍스트 크기?, 스마트 폰의 기능을 최대한 활용하지 못하고 계신대
    그러한 부분을 개선시켜줄 수 있는 무언가 형용할 수 없지만. `3`
...
#### 패셔니스타를 위한 앱
    ...
    자기 스타일에 맞는 쇼핑몰을 추천. 퍼스널 컬러 진단 액세서리 추천 `2`

#### 집에서 내가 버스 정류장을 지정하면 몇 분 남아있는지 알려주는 기능
    학교 갈 시간이 되면 알아서 해주든가. ;LED로 보여준다거나 알람이 울린다든가 `2`
